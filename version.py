...
# 版本历史
VERSION_HISTORY = {
    "1.0.0": {"date": "2025-01-01", "description": "初始版本 - 智能模型选择 + 故障转移"},
    "2.0.0": {
        "date": "2025-02-25",
    ...
    "3.0.0": {"date": "2026-03-01", "description": "架构升级: 通用核心 + 适配器模式, 六边形架构"},
    "3.1.0": {"date": "2026-03-02", "description": "配置驱动: models_config.json, 零代码添加模型"},
    "4.0.0": {"date": "2026-03-02", "description": "V2.0增强期: YAML配置+性能埋点+动态降级"},
    "4.0.1": {"date": "2026-03-02", "description": "Bug 修复: 代码重构优化"},
    "4.1.0": {"date": "2026-04-02", "description": "架构重构: 物理级双引擎分配与意图直达"},
    "4.1.1": {"date": "2026-04-06", "description": "修复: OpenCode 集成问题修复，模型智能切换优化"},
    "4.1.2": {"date": "2026-04-06", "description": "修复: CLI输出纯模型ID，兼容OpenCode解析"},
    "4.1.3": {
        "date": "2026-04-06",
