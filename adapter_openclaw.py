...
class OpenClawAdapter(BaseAPIServerAdapter):
    ...
    def parse_request(self, raw_input: Any) -> Dict[str, Any]:
        ...
        if isinstance(raw_input, dict):
            ...
            return {
                ...
                "metadata": {"source": "openclaw_api", "provider": "openclaw"},
            }
    ...
    def parse_chat_request(self, request_data: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "stream": stream,
            "metadata": {"source": "openclaw_chat", "provider": "openclaw"},
        }
...
def create_chat_completion(adapter: OpenClawAdapter, core, request_data: Dict) -> Dict:
    """
    创建聊天完成响应
